...
class Catalogs:
    def __init__(self, url: str, initial: datetime.date, final: datetime.date or str, region: str, variables: list[str]):
        self.url = url
        self.i_date = initial
        self.f_date = final
        self.region = region
...
hycom_catalogs = {
    'ESPC-D-V02': Catalogs(
        ...
        region='Global 1/12° Analysis', variables=['ice', 'steric ssh', 'surf el', 'salinity',
    ...
    'GLBy0.08 - expt_93.0': Catalogs(
        ...
        region='HYCOM + NCODA Global 1/12° Analysis (NRL)', variables=['ssh', 'water_temp', 'salinity', 'water_u',
                                                                       'water_v']
    ),
    ...
    'GLBv0.08 - expt_53.X': Catalogs(
        ...
        region='HYCOM + NCODA Global 1/12° Reanalysis (NRL)', variables=['ssh', 'water_temp', 'salinity', 'water_u',
                                                                       'water_v']
    ),
    ...
    'GOMb0.01 - reanalysis': Catalogs(
        ...
        region='HYCOM-TSIS 1/100º Gulf of Mexico Reanalysis', variables=['water_temp', 'salinity', 'water_u',
    ...
    'GOMb0.04 - reanalysis': Catalogs(
        ...
        initial=datetime(year=2001, month=1, day=1), final=datetime(year=2024, month=12, day=31),
        region='HYCOM-TSIS 1/25º Gulf of Mexico Reanalysis', variables=['water_temp', 'salinity', 'water_u',
                                                                       'water_v', 'water_w', '10u', '10v']
    ),
    ...
    'GOMu0.04 - expt_90.1m000': Catalogs(
        ...
        region='HYCOM + NCODA Gulf of Mexico 1/25° Analysis (NRL)', variables=['ssh', 'water_temp', 'salinity',
                                                                               'water_u', 'water_v']
    ),
    ...
    'GOMu0.04 - expt_50.1': Catalogs(
        ...
        region='HYCOM + NCODA Gulf of Mexico 1/25° Reanalysis (NRL)', variables=['ssh', 'water_temp', 'salinity',
                                                                               'water_u', 'water_v']
    ),
    ...
    'GOMl0.04 - expt_32.5': Catalogs(
        ...
        region='HYCOM + NCODA Southeast United States 1/25 Degree Analysis', variables=['water_temp', 'salinity',
    ...
    'GLBu0.08 - expt_19.0': Catalogs(
        ...
        region='GOFS 3.0: HYCOM + NCODA Global 1/12° Reanalysis', variables=['ssh', 'water_temp', 'salinity',
                                                                               'water_u', 'water_v']
    ),
