...
################################################################################
## Form generated from reading UI file 'Temperature_LonDepthProfile_ButtonsRokthW.ui'
##
...
class Ui_WindButton_LonLatProfile(object):
    ...
    def save_fig(self):
        ...
        plt.savefig(f'{path_to_save}\\DEPTHvsLON_{t_formated}_LATcoord{self.comboBox.currentText()}.png',
                    transparent=True)
        plt.close()
